...
CREATE TABLE [dbo].[OrderProgress](
	...
	FOREIGN KEY([createdBy]) REFERENCES [dbo].[Seller] ([sellerId]),
	FOREIGN KEY([createdBy]) REFERENCES [dbo].[customer] (customerId),
	FOREIGN KEY([createdBy]) REFERENCES [dbo].[Shipper] ([shipperId]),
	FOREIGN KEY([orderId]) REFERENCES [dbo].[Order] ([orderId]),
PRIMARY KEY CLUSTERED 
(
	[orderProgressId] ASC
