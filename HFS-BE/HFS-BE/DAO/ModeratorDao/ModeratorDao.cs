...
namespace HFS_BE.DAO.ModeratorDao
{
    public class ModeratorDao : BaseDao
    {
        ...
        public BaseOutputDto CreateMenuModerator(CreateModeratorDaoDtoInput model)
        {
            ...
            var moderatorPhone = context.MenuModerators.FirstOrDefault(mm => mm.PhoneNumber == model.PhoneNumber);

            if (moderatorPhone != null)
            {
        ...
        public BaseOutputDto CreatePostModerator(CreateModeratorDaoDtoInput model)
        {
            ...
            var moderatorPhone = context.PostModerators.FirstOrDefault(pm => pm.PhoneNumber == model.PhoneNumber);
            if (moderatorPhone != null)
            {
                return this.Output<BaseOutputDto>(Constants.ResultCdFail, "Phone number has been used");
            }
        ...
        public BaseOutputDto CreateAccountant(CreateModeratorDaoDtoInput model)
        {
            ...
            var moderatorPhone = context.Accountants.FirstOrDefault(ac => ac.PhoneNumber == model.PhoneNumber);
            if (moderatorPhone != null)
            {
                return this.Output<BaseOutputDto>(Constants.ResultCdFail, "Phone number has been used");
            }
