...
{
    public class GetOrderExternalBusinessLogic : BaseBusinessLogic
    {
        public GetOrderExternalBusinessLogic(SEP490_HFS_2Context context, IMapper mapper) : base(context, mapper)
        {
        }
