...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Admin>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__Admin__AB6E6164953945B8")
                    .IsUnique();
            ...
            modelBuilder.Entity<CartItem>(entity =>
            {
                entity.HasKey(e => new { e.FoodId, e.CartId })
                    .HasName("PK__CartItem__E3FF5A0259686ECE");
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__Customer__AB6E61642B16B152")
                    .IsUnique();
            ...
            modelBuilder.Entity<Feedback>(entity =>
            {
                ...
                entity.HasOne(d => d.Food)
                    .WithMany(p => p.Feedbacks)
                    .HasForeignKey(d => d.FoodId)
                    .HasConstraintName("FK__Feedback__foodId__5629CD9C");
            });

            modelBuilder.Entity<FeedbackReply>(entity =>
            {
                entity.HasKey(e => e.ReplyId)
                    .HasName("PK__Feedback__36BBF6881753BC1D");
                ...
                entity.HasOne(d => d.Feedback)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__FeedbackR__feedb__5BE2A6F2");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.FeedbackReplies)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__FeedbackR__userI__59FA5E80");

                entity.HasOne(d => d.UserNavigation)
                    .WithMany(p => p.FeedbackReplies)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__FeedbackR__userI__5AEE82B9");
            });

            modelBuilder.Entity<FeedbackVote>(entity =>
            {
                entity.HasKey(e => e.VoteId)
                    .HasName("PK__Feedback__78F0B9F30486E1DC");
                ...
                entity.HasOne(d => d.Feedback)
                    ...
                    .HasForeignKey(d => d.FeedbackId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__FeedbackV__feedb__5FB337D6");

                entity.HasOne(d => d.VoteByNavigation)
                    .WithMany(p => p.FeedbackVotes)
                    .HasForeignKey(d => d.VoteBy)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__FeedbackV__voteB__5EBF139D");
            });
            ...
            modelBuilder.Entity<Food>(entity =>
            {
                ...
                entity.HasOne(d => d.Seller)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Food__sellerId__5165187F");
            });

            modelBuilder.Entity<FoodImage>(entity =>
            {
                entity.HasKey(e => e.ImageId)
                    .HasName("PK__FoodImag__336E9B55D224AD92");
            ...
            modelBuilder.Entity<MenuModerator>(entity =>
            {
                entity.HasKey(e => e.ModId)
                    .HasName("PK__MenuMode__0B7D023B6F926E95");

                entity.ToTable("MenuModerator");

                entity.HasIndex(e => e.Email, "UQ__MenuMode__AB6E61644423A178")
                    .IsUnique();
            ...
            modelBuilder.Entity<MenuReport>(entity =>
            {
                entity.HasKey(e => new { e.FoodId, e.ReportBy })
                    .HasName("PK__MenuRepo__C62346BB238A02CC");
            ...
            modelBuilder.Entity<Notification>(entity =>
            {
                ...
                entity.HasOne(d => d.ReceiverNavigation)
                    ...
                    .HasConstraintName("FK__Notificat__recei__778AC167");
                ...
                entity.HasOne(d => d.SendBy2)
                    ...
                    .HasForeignKey(d => d.SendBy)
                    .HasConstraintName("FK__Notificat__sendB__73BA3083");

                entity.HasOne(d => d.SendBy3)
                    .WithMany(p => p.NotificationSendBy3s)
                    .HasForeignKey(d => d.SendBy)
                    .HasConstraintName("FK__Notificat__sendB__74AE54BC");

                entity.HasOne(d => d.SendBy4)
                    .WithMany(p => p.NotificationSendBy4s)
                    .HasForeignKey(d => d.SendBy)
                    .HasConstraintName("FK__Notificat__sendB__70DDC3D8");

                entity.HasOne(d => d.SendBy5)
                    .WithMany(p => p.NotificationSendBy5s)
                    .HasForeignKey(d => d.SendBy)
                    .HasConstraintName("FK__Notificat__sendB__72C60C4A");

                entity.HasOne(d => d.Type)
                    .WithMany(p => p.Notifications)
                    .HasForeignKey(d => d.TypeId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Notificat__typeI__7B5B524B");
            });
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.HasOne(d => d.Customer)
                    .WithMany(p => p.Orders)
                    .HasForeignKey(d => d.CustomerId)
                    .HasConstraintName("FK__Order__customerI__02FC7413");

                entity.HasOne(d => d.Seller)
                    .WithMany(p => p.Orders)
                    .HasForeignKey(d => d.SellerId)
                    .HasConstraintName("FK__Order__sellerId__02084FDA");

                entity.HasOne(d => d.Shipper)
                    .WithMany(p => p.Orders)
                    .HasForeignKey(d => d.ShipperId)
                    .HasConstraintName("FK__Order__shipperId__03F0984C");

                entity.HasOne(d => d.Voucher)
                    .WithMany(p => p.Orders)
                    .HasForeignKey(d => d.VoucherId)
                    .HasConstraintName("FK__Order__voucherId__04E4BC85");
            });

            modelBuilder.Entity<OrderDetail>(entity =>
            {
                entity.HasKey(e => new { e.OrderId, e.FoodId })
                    .HasName("PK__OrderDet__8F779DFE3159F312");
                ...
                entity.HasOne(d => d.Food)
                    ...
                    .HasForeignKey(d => d.FoodId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__OrderDeta__foodI__09A971A2");
            ...
            modelBuilder.Entity<OrderProgress>(entity =>
            {
                ...
                entity.HasOne(d => d.CreatedByNavigation)
                    ...
                    .HasConstraintName("FK__OrderProg__creat__0D7A0286");

                entity.HasOne(d => d.CreatedBy1)
                    .WithMany(p => p.OrderProgresses)
                    .HasForeignKey(d => d.CreatedBy)
                    .HasConstraintName("FK__OrderProg__creat__0C85DE4D");

                entity.HasOne(d => d.CreatedBy2)
                    .WithMany(p => p.OrderProgresses)
                    .HasForeignKey(d => d.CreatedBy)
                    .HasConstraintName("FK__OrderProg__creat__0E6E26BF");

                entity.HasOne(d => d.Order)
                    .WithMany(p => p.OrderProgresses)
                    .HasForeignKey(d => d.OrderId)
                    .HasConstraintName("FK__OrderProg__order__0F624AF8");
            });
            ...
            {
                entity.HasKey(e => e.ImageId)
                    .HasName("PK__PostImag__336E9B55EC6A45FA");
            ...
            {
                entity.HasKey(e => e.ModId)
                    .HasName("PK__PostMode__0B7D023BF87ACA5F");

                entity.ToTable("PostModerator");

                entity.HasIndex(e => e.Email, "UQ__PostMode__AB6E6164CD900FBB")
                    .IsUnique();
            ...
            modelBuilder.Entity<PostReport>(entity =>
            {
                entity.HasKey(e => new { e.PostId, e.ReportBy })
                    .HasName("PK__PostRepo__6CC5DF18544B7751");
            ...
            modelBuilder.Entity<Seller>(entity =>
            {
                ...
                entity.Property(e => e.CheckSeller)
                    .IsRequired()
                    .HasColumnName("checkSeller")
                    .HasDefaultValueSql("('false')");
            ...
            modelBuilder.Entity<ShipAddress>(entity =>
            {
                entity.HasKey(e => e.AddressId)
                    .HasName("PK__ShipAddr__26A111AD59A578DB");
            ...
            modelBuilder.Entity<Shipper>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__Shipper__AB6E6164389E8EE6")
                    .IsUnique();
            ...
            modelBuilder.Entity<Voucher>(entity =>
            {
                ...
                entity.HasOne(d => d.Seller)
                    ...
                    .HasForeignKey(d => d.SellerId)
                    .HasConstraintName("FK__Voucher__sellerI__7E37BEF6");
            });
