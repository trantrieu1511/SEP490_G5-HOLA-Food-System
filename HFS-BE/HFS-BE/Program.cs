...
builder.Services.AddCors(act =>
{
    act.AddPolicy("_MainPolicy", options =>
    {
        ...
        options.WithOrigins("https://fu.holafood.click", "https://fu.holafood.click/*", "https://www.fu.holafood.click", "http://localhost:4200", "https://provinces.open-api.vn/api"); // Ch? ??nh ngu?n g?c c? th?
