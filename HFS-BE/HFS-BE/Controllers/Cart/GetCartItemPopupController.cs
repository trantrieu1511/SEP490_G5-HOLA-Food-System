...
{
    public class GetCartItemPopupController : BaseController
    {
        public GetCartItemPopupController(SEP490_HFS_2Context context, IMapper mapper) : base(context, mapper)
        {
        }

        [HttpPost]
        [Route("cart/getcartitempopup")]
        [Authorize]
        public GetCartItemDaoOutputDto GetCartItem()
        {
            try
            {
                ...
                var busi = this.GetBusinessLogic<GetCartItemPopupBusinessLogic>();
